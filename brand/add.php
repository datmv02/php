...
if (isset($_POST['submit'])) {
    ...
    if ($is_flag == true) {
        $queryInsert = "INSERT Into products(`product_name`,`price`,`quantity`,`image`,`description`,`brand_id`)
        values ('$name',$price,$quantity,'$image','$description',$brand)";
        exeQuery($queryInsert, false);
        ...
        <div class="row" style="justify-content: center;">
            <form action="" method="post" class="col-sm-4" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control <?= isset($vali['quantity']) ? $vali['quantity'] : "" ?>" name="quantity" value="<?= isset($quantity) ? $quantity : '' ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control <?= isset($vali['description']) ? $vali['description'] : "" ?>" id="" rows="4"><?= isset($description) ? $description : '' ?></textarea>
                    <div class="invalid-feedback">
                        Description require
                    </div>
                </div>
