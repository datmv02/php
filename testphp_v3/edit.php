...
if ($id == -1) {
    ...
    $queryGetId = "SELECT * FROM bai_viet inner JOIN danh_muc on bai_viet.danhmuc_id = danh_muc.danhmuc_id where id = $id";
    $resultId = exeQuery($queryGetId,false);
...
if (isset($_POST['submit'])) {
    ...
    if ($is_flag == true) {
        $query1 = "INSERT into bai_viet(`tieu_de`,`noi_dung`,`anh`,`so_luot_like`,`danhmuc_id`) values('$name','$detail','$image',$like,$danhmuc)";
        ...
        <div class="row" sryle="justify-content: center;">
            <form action="add.php" method="post" enctype="multipart/form-data" class="form col-sm-5">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  <?= isset($vali['name']) ? $vali['name'] : "" ?>" name="name" value="<?= isset($resultId['tieu_de']) ? $resultId['tieu_de'] : "" ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  <?= isset($vali['detail']) ? $vali['detail'] : "" ?>" name="detail" value="<?= isset($resultId['noi_dung']) ? $resultId['noi_dung'] : "" ?>">
                    <div class="invalid-feedback">
                        noi dung required
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control  <?= isset($vali['like']) ? $vali['like'] : "" ?>" name="like" value="<?= isset($resultId['so_luot_like']) ? $resultId['so_luot_like'] : "" ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select name="danhmuc" class="form-control  <?= isset($vali['danhmuc']) ? $vali['danhmuc'] : "" ?>">
                        <option value="<?= $resultId['danhmuc_id'] ?>"><?= $resultId['name'] ?></option>
